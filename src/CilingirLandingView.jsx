  ...
  ‘@graph’: [
    {
      ...
      ‘name’: ‘Çilingirciniz’,
      ‘description’: ‘İstanbul Avrupa Yakası\’nda 2014\’ten beri 7/24 acil çilingir hizmeti. Kapı açma, kilit değişimi, oto çilingir. Ortalama 20-30 dakika.’,
      ‘url’: BASE_URL,
      ...
      ‘sameAs’: [
        ‘https://twitter.com/cilingirciniz’,
        `${BASE_URL}/locksmith-istanbul`,
      ],
      ‘speakable’: {
        ‘@type’: ‘SpeakableSpecification’,
        ‘cssSelector’: [‘h1’, ‘#faq’, ‘#services’],
      },
    },
    {
      ‘@type’: ‘HowTo’,
      ‘@id’: `${BASE_URL}/#howto`,
      ‘name’: ‘Kapıda Kaldığınızda Ne Yapmalısınız?’,
      ‘description’: ‘İstanbul\’da kapıda kaldığınızda acil çilingir çağırma adımları. Beşiktaş, Şişli, Sarıyer, Kağıthane ve Eyüpsultan\’da geçerlidir.’,
      ‘totalTime’: ‘PT30M’,
      ‘step’: [
        {
          ‘@type’: ‘HowToStep’,
          ‘position’: 1,
          ‘name’: ‘7/24 Çilingiri Arayın’,
          ‘text’: ‘0538 059 01 73 numaralı hattı arayın. Gece yarısı, tatil ve hafta sonu dahil her saat aktiftir.’,
        },
        {
          ‘@type’: ‘HowToStep’,
          ‘position’: 2,
          ‘name’: ‘Adres ve Kapı Bilgisini Verin’,
          ‘text’: ‘Mahalle, bina adı ve daire numarasını söyleyin. Çelik kapı mı, ahşap kapı mı olduğunu da belirtin.’,
        },
        {
          ‘@type’: ‘HowToStep’,
          ‘position’: 3,
          ‘name’: ‘Teknisyeri Bekleyin’,
          ‘text’: ‘Ekibimiz ortalama 20-30 dakikada kapınıza gelir. Yoğun saatlerde kesin süre telefonda bildirilir.’,
        },
        {
          ‘@type’: ‘HowToStep’,
          ‘position’: 4,
          ‘name’: ‘Hasarsız Açma ve Gerekirse Kilit Değişimi’,
          ‘text’: ‘Profesyonel ekipmanla hasarsız açma uygulanır. Kilitde hasar varsa yerinde silindir değişimi yapılır.’,
        },
      ],
    },
  ],
